...
class Game:
    ...
    def start_game(self, image_str):
        ...
        theme = 'dragon'
        soul_read_output = soul_read(self.story_image_str)
        self.soul_read = soul_read_output
        self.emotion = run_text_inference(f"YOU MUST ONLY OUTPUT 1 WORD WITH NO PUNCUATION. Output a 1 word descriptive emotion summarizing the following: {soul_read_output}")
